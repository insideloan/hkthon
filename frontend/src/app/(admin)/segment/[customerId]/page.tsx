      ...
      <div className="sg-wrap mx-auto max-w-[1160px]">
        ...
        >
          ...
          <div className="sg-counter flex flex-col items-center gap-[10px] px-0 pt-[16px] pb-[14px] mb-[13px]">
            <span className="sg-clbl block w-full rounded-[10px] border border-white/30 bg-route px-[14px] py-[9px] text-center text-[16px] font-bold tracking-[.01em] text-white shadow-[0_2px_8px_-2px_rgba(37,99,235,.5)]">
              세그먼트 조합 수
            </span>
            <span
              id="combo"
          ...
          >
            ...
            {/* Column headers */}
            <text className="ts" x="114" y="28" textAnchor="middle" fontSize="15" fontWeight="800" fill="var(--ink)">원천 데이터 (9항목)</text>
            <text className="ts" x="340" y="28" textAnchor="middle" fontSize="15" fontWeight="800" fill="var(--ink)">군집 (4대 분류)</text>
            <text className="ts" x="569" y="28" textAnchor="middle" fontSize="15" fontWeight="800" fill="var(--ink)">세그먼트</text>
            ...
            <g className="cat" data-i="0" data-testid="sg-categories">
              ...
              <text className="ts" x="42" y="56" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">차량 보유</text>
            ...
            <g className="cat" data-i="1">
              ...
              <text className="ts" x="42" y="108" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">주식 보유</text>
            ...
            <g className="cat" data-i="2">
              ...
              <text className="ts" x="42" y="160" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">신용 평점</text>
            ...
            <g className="cat" data-i="3">
              ...
              <text className="ts" x="42" y="212" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">부채(A저축)</text>
            ...
            <g className="cat" data-i="4">
              ...
              <text className="ts" x="42" y="264" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">대출반응확률</text>
            ...
            <g className="cat" data-i="5">
              ...
              <text className="ts" x="42" y="316" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">금리민감확률</text>
            ...
            <g className="cat" data-i="6">
              ...
              <text className="ts" x="42" y="368" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">부도확률</text>
            ...
            <g className="cat" data-i="7">
              ...
              <text className="ts" x="42" y="420" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">대출비교 조회</text>
            ...
            <g className="cat" data-i="8">
              ...
              <text className="ts" x="42" y="472" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">앱 행태이력</text>
            ...
            <g className="clu" data-c="A">
              ...
              <text className="th" x="340" y="75" textAnchor="middle" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">고객 자산·여력</text>
            ...
            <g className="clu" data-c="B">
              ...
              <text className="th" x="340" y="179" textAnchor="middle" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">신용·부채</text>
            ...
            <g className="clu" data-c="C">
              ...
              <text className="th" x="340" y="309" textAnchor="middle" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">ML 예측모형</text>
            ...
            <g className="clu" data-c="D">
              ...
              <text className="th" x="340" y="439" textAnchor="middle" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--ink-dim)">온라인 행동</text>
            ...
            <g className="clu" data-c="cv">
              ...
              <text className="ts" x="460" y="264" textAnchor="middle" dominantBaseline="central" fontSize="14" fontWeight="800" fill="var(--route)">조합</text>
            </g>
            ...
            <text className="ts" x="569" y="432" textAnchor="middle" fontSize="13" fontWeight="700" fill="var(--ink-dim)" opacity="0.9">… 외 다수</text>
            ...
            >
              <g className="c-blue">
                ...
                <text className="th" x="569" y="256" textAnchor="middle" dominantBaseline="central" fontSize="15" fontWeight="800" fill="var(--route)">고금리 대환 타겟군</text>
                <text className="ts" x="569" y="276" textAnchor="middle" dominantBaseline="central" fontSize="13" fontWeight="600" fill="var(--route)">자동차 담보 제안 가능</text>
              </g>
            </g>
          </svg>
        </div>
        ...
        <div className="sg-side w-full lg:w-[420px] lg:flex-none" data-testid="segment-side">
          <div className="glass-card sg-sec px-[17px] py-[15px]">
            <span className="sg-tag t2 mb-[11px] flex w-full items-center justify-center gap-1.5 rounded-[10px] border border-white/30 bg-route px-[14px] py-[9px] text-center text-[16px] font-bold tracking-[.01em] text-white shadow-[0_2px_8px_-2px_rgba(37,99,235,.5)]">
              상담 전략
              {!analysisComplete && (
                <span
