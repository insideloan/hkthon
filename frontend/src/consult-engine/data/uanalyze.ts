...
export const UANALYZE: UAnalyzeEntry[] = [
  {
    // 0 대출 거부 (s1.json seq2 정합: 거부감/연락중단/대출거부)
  ...
  {
    // 1 불신·조건 의심 (s1.json seq4 정합: 의심/대환가능성/기존대출비교후판단)
  ...
  {
    // 4 담보 오해 (불안) (s1.json seq6 정합: 불안/상품확인/설명추가필요)
  ...
  {
    // 6 확인만 해보자 (수용, 서류 번거로움 우려) (s1.json seq8 정합: 수용/절차서류/AI접수필요)
