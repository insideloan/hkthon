...
uv add fastapi 'uvicorn[standard]' websockets sqlmodel aiosqlite pydantic pydantic-settings httpx boto3 openai python-multipart
...
- Stack: FastAPI + Next.js + SQLite + Bedrock/OpenAI + Naver Clova
