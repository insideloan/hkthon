...
> **목적 / Purpose**: PRODUCT-BRIEF의 "2가지 시나리오"를 **데모 가능한 feature**들로 분해하고 우선순위를 매김. 1회 실행.
> Decompose the 2 PRODUCT-BRIEF scenarios into demoable features with priority. Run once.
...
1. **"데모의 happy path는? S1 → S2 순서로 보여줄까요, 아니면 S1만 깊게?"**
...
PRODUCT-BRIEF의 §3 (2 시나리오) + §4 (화면 구성)을 따라 **8-15개 feature**를 도출.
...
| 시나리오 | P0 | P1 | P2 |
|---|---|---|---|
| S1 (상품관심/한도조회) — main happy path | F01..F05 | F12 | — |
| S2 (보이스피싱 의심) | F06 | — | — |
| Cross (UI 공통) | F07, F08, F09 | — | — |
| Polish | — | F10, F11 | F12 |
